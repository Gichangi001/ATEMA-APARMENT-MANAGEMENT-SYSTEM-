     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn menu-icon-renter">
                     <a href="renter.php" class="non-style-link-menu"><div><p class="menu-text">My Renters</p></a></div>
                 </td>
             </tr>
             <tr class="menu-row" >
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-checked"  style="padding-right: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Vist site</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
