            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  schedule where techid=$userid;");
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,technician.techname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join technician on schedule.techid=technician.techid where technician.techid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="payments.php" class="non-style-link">
    <button class="btn-primary-soft btn button-icon btn-checked" style="padding-right: 40px; padding-top: 12px; padding-bottom: 12px; margin-top: 10px;">
        <font class="tn-in-text">Visit site</font>
    </button>
</a>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-tech-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Renter that Already registerd for this session:</b> ('.$result12->num_rows."/".$nop.')</label>
                                    <br><br>
                                </td>
                            </tr>
