            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-technician">
                        <a href="technician.php" class="non-style-link-menu"><div><p class="menu-text">All technician</p></a></div>
                    </td>
                </tr>
                    ...
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div class="btn-icon-back dashboard-icons-setting " style="background-image: url('../img/icons/view-.svg');"></div>
                                        <div>
                                                <div class="h1-dashboard" >
